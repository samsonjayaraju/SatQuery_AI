...
DEFAULT_MODELS = (
    ...
    ModelDefinition("remoteclip_encoder", "RemoteCLIP", "interface-v1", ("embedding", "classification"), ("optical", "multispectral"), "remoteclip/model.safetensors", "adapter"),
    ModelDefinition("satquery_adapter", "SatQuery Remote-Sensing Adapter", "0.1", ("classification", "embedding"), ("optical", "sar"), "satquery-adapter/best.pt", "trainable_adapter"),
    ModelDefinition("changeformer", "ChangeFormer", "interface-v1", ("change_detection",), ("bi_temporal",), "changeformer/model.pth", "adapter"),
